...
const approaches = [
    {
        ...
        description: 'Understanding who is affected, who resists, and who champions.',
    },
    {
        icon: Target,
        title: 'Adoption Strategy',
        description: 'Designing rollout approaches that maximize uptake and minimize friction.',
    },
    {
        icon: Lightbulb,
        title: 'Enablement & Incentives',
        description: 'Creating the conditions, training, and motivation for behavior change.',
    },
    {
        icon: Repeat,
        title: 'Reinforcement Loops',
        description: 'Building feedback mechanisms that sustain new behaviors over time.',
    },
]

export default function ChangeAdoptionPage() {
    return (
            ...
            <section className="pt-32 pb-20 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h1 className="heading-xl mb-6">
                        Change, Adoption & Behavior
                    </h1>

                    <p className="text-xl text-gray-400 font-light max-w-2xl leading-relaxed mb-8">
                        Adoption is the last mile. We close it. Systems only work when
                        people actually use them—we design for behavior change, not just deployment.
                    </p>
                    ...
                    <div className="glass-card rounded-lg inline-block">
                        ...
                        <p className="text-gray-300">
                            Activate the system and embed it into daily behavior.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-6 text-center bg-gradient-to-t from-[#22c55e]/5 to-transparent">
                <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-gray-500 mb-8">
                        Let&apos;s make sure people actually use what you build.
                    </p>
