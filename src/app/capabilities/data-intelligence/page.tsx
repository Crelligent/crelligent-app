...
const keyQuestions = [
    ...
    'Where should intelligence be embedded?',
...
const approaches = [
    {
        ...
        description: 'Identifying what data exists, what\'s missing, and what signals actually matter.',
    },
    {
        icon: LineChart,
        title: 'Pipeline Design',
        description: 'Architecting data flows that deliver the right information at the right time.',
    },
    {
        icon: Brain,
        title: 'Analytics & ML',
        description: 'Turning raw data into predictions, patterns, and actionable intelligence.',
    },
    {
        icon: Repeat,
        title: 'Insight Feedback Loops',
        description: 'Ensuring intelligence actually flows back into decision-making.',
    },
]
            ...
            <section className="pt-32 pb-20 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-xl text-gray-400 font-light max-w-2xl leading-relaxed mb-8">
                        Data is the nervous system of your organization. We design intelligence
                        that helps your system sense, learn, and adapt—not just report.
                    </p>
                    ...
                    <div className="glass-card rounded-lg inline-block">
                        ...
                        <p className="text-gray-300">
                            Turn operational data into intelligence for decision-making and automation.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-6 text-center bg-gradient-to-t from-[#8b5cf6]/5 to-transparent">
                <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-gray-500 mb-8">
                        Let&apos;s design intelligence that actually drives decisions.
                    </p>
